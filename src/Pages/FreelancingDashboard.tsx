...
const FreelancingDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<
    "overview" | "browseJobs" | "analytics" | "profile" | "myApplications" | "messages"
  >("overview");
  ...
  useEffect(() => {
    ...
    if (
      state?.tab &&
      ["overview", "browseJobs", "analytics", "myApplications"].includes(state.tab)
    ) {
        ...
        {activeTab === "analytics" && (
          ...
          >
            <div className="mb-6 sm:mb-8">
              ...
              >
                Comprehensive insights into your freelance performance and market trends
              </p>
            </div>
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    ...
                    >
                      ${analyticsData.earnings.toLocaleString()}
                    </p>
                    <p
                      className={`text-sm ${darkMode ? "text-gray-400" : "text-gray-600"
                        }`}
              ...
              >
                ...
                <div className="space-y-4">
                  {analyticsData.skillDemand.length > 0 ? (
                    analyticsData.skillDemand.map((item, index) => (
                      <div
                        key={item.skill}
                        className="flex items-center justify-between"
                      >
                        <div className="flex-1">
                          ...
                          >
                            {item.demand} job postings
                          </p>
                        </div>
                        <div
                          className={`text-sm font-semibold ${item.avgSalary >= 6000
                            ? "text-green-500"
                            : item.avgSalary >= 5000
                              ? "text-blue-500"
                              : item.avgSalary >= 4000
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              >
                <h4
                  className={`text-base font-semibold mb-3 ${darkMode ? "text-white" : "text-black"
                    }`}
                >
                  Profile Views
                </h4>
                <div className="text-center">
                  <p
                    className={`text-3xl font-bold mb-1 ${darkMode ? "text-white" : "text-black"
                      }`}
                  >
