      ...
      <div className="relative z-10 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-4 mb-4">
              <motion.div
                className={`p-4 rounded-2xl ${
                  darkMode 
                    ? "bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 shadow-[0_0_30px_rgba(6,182,212,0.3)]" 
                    : "bg-gradient-to-br from-cyan-100 to-blue-100 border border-cyan-200 shadow-lg"
                }`}
          ...
          <motion.div
            ...
            className={`flex gap-3 mb-8 backdrop-blur-xl rounded-2xl p-2 ${
              darkMode 
            ...
            {tabs.map((tab) => {
              ...
              return (
                <motion.button
                  ...
                  className={`relative px-6 py-4 font-bold flex items-center gap-3 transition-all rounded-xl z-10 ${
                    isActive
                      ? darkMode
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className={`rounded-3xl border-2 overflow-hidden backdrop-blur-xl shadow-2xl ${
                darkMode
